...
pub fn tr(language: Language, key: TKey) -> &'static str {
    match language {
        Language::En => match key {
            ...
            TKey::ImportUnavailable => "Markdown import is available through the CLI.",
            ...
            TKey::ReadOnlyImportNote => "`mge import markdown <path> --scope <scope>`",
        ...
        Language::Ru => match key {
            ...
            TKey::ImportUnavailable => "Markdown import доступен через CLI.",
