...
`mge validate` - read-only consistency check для manifest, page catalog, page files, page checksums, marker references, cell links, candidate index coverage и orphan storage files.
